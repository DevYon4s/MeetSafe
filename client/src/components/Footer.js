        ...
        <div className="footer-grid">
          <div className="footer-col">
            <div className="footer-brand">
              <h3 className="footer-title"><Link to="/" className="footer-link">MeetSafe</Link></h3>
            ...
            <p className="footer-text">
              Secure, Verified, Real-World Connections
            </p>
          </div>
            ...
            <ul className="footer-links">
              ...
              <li>
                <Link to="/terms-of-service" className="footer-link">
                  Your verified data will be shared with law enforcement in case of misconduct and bad behaviors
                </Link>
              </li>
            </ul>
          </div>
